...
create table trailer(
    trailerID int(5) not null AUTO_INCREMENT,
    trailerLength int(2),
...
create table studio(
    studioID int(5) not null AUTO_INCREMENT,
...
create table soundtrack(
    soundtrackID int(5) not null AUTO_INCREMENT,
...
create table artiste(
    artisteID int(5) not null AUTO_INCREMENT,
